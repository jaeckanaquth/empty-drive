...
export default function DeepEval() {
  ...
  return (
    <Stack gap={28} style={{ padding: '24px 28px', maxWidth: 1020 }}>
      ...
      <Stack gap={6}>
        <H2>Criterion 1 — Extended corridors</H2>
        <Text size="small" tone="secondary">
          IVC Road, KIADB Aerospace Park (Bagalur), and all watch-list pins are documented in{' '}
          <Text weight="semibold" as="span">blr-areas.canvas.tsx</Text> (watch-list table + five core micro-markets).
          This file stays the 10-point matrix only so area narrative is not duplicated across canvases.
        </Text>
      </Stack>
