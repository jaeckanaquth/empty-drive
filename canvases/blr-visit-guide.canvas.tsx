...
const visits = [
  {
    ...
    address: 'Doddaballapur Main Road, Yelahanka, Bangalore – 560064',
    mapSearch: 'Prestige Royale Gardens Yelahanka Bangalore',
    type: 'RTM resale',
    priceRange: '₹1.5–1.95 Cr',
    size: '1,705 sqft SBA',
    contactApproach: 'Search on 99acres / Housing.com for active resale listings. Contact 2–3 listed brokers directly. Ask for units on 5th floor and above, north/east facing.',
    bestVisitTime: 'Weekday 7–8 AM (see gym) or 6–7 PM (see evening activity + lighting)',
    driveFromYelahanka: '~10 min',
    priority: 'Must Visit',
  },
  {
  ...
  },
  {
    ...
    address: 'Yelahanka – Doddaballapur Main Road, Bangalore – 560064',
    mapSearch: 'Godrej Avenues Yelahanka Bangalore',
    type: 'RTM resale',
    priceRange: '₹1.4–1.75 Cr',
    size: '1,420–1,750 sqft SBA',
    contactApproach: 'RERA number: PRM/KA/RERA/1251/309/PR/170905/000229. Search directly on 99acres. Multiple units available — good selection. Tell broker: no B-Khata, want OC certificate copy.',
    bestVisitTime: 'Same day as Prestige Royale (both on Doddaballapur Rd side) — batch the visits',
    driveFromYelahanka: '~10 min',
    priority: 'Must Visit',
  },
  {
    ...
    mapSearch: 'Sobha City Thanisandra Bangalore',
    type: 'RTM resale',
    priceRange: '₹2.2–2.6 Cr',
    size: '1,682–2,164 sqft SBA',
    contactApproach: 'Contact Sobha directly (sobha.com) for RTM resale inventory. Also check 99acres for individual owner listings — can be ₹10–15L cheaper than builder channel.',
    bestVisitTime: 'Visit on a different day from Yelahanka properties (Thanisandra is 25 min away)',
    driveFromYelahanka: '~25 min',
    priority: 'Should Visit',
  },
  {
    id: 'sobha-athena',
    rank: 5,
    name: 'Sobha Athena (UC site)',
    builder: 'Sobha Limited',
    address: 'Thanisandra Main Road, Bangalore – 560077',
    ...
    contactApproach: 'Visit Sobha sales office at the site. Check RERA portal for % completion (search RERA number). Ask for detailed payment plan and construction timeline.',
    bestVisitTime: 'Combine with Sobha City visit — both Thanisandra, same day',
    driveFromYelahanka: '~25 min',
    priority: 'Visit if RTM options disappoint',
  },
];
